<x-app-layout>
    @auth
        <x-forms.form
            ...
            method="PUT"
            title="Edit Post"
            description="Update your blog post using the form below."
        ...
        >{{ old('excerpt', $post->excerpt) }}</x-forms.inputs.textarea>
        ...
        >{{ old('content', $post->content) }}</x-forms.inputs.wysiwyg-editor>
        ...
        <div class="border-t border-gray-200 dark:border-gray-600 pt-6 mt-6">
            ...
            >{{ old('meta_description', $post->meta_description) }}</x-forms.inputs.textarea>
        </div>
        ...
        <!-- Post Information -->
        <div class="border-t border-gray-200 dark:border-gray-600 pt-6 mt-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Post Information</h3>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-6">You must be logged in to edit a post.</p>
                    <div class="space-x-4">
